...
class Window1:
    def __init__(self, root):
        ...
        self.txtPassword=Entry(root,font=("Arial", 15),bd=0,textvariable=self.Password)
        self.txtPassword.place(x=750,y=520)
        ...
        #self.lblPassword=Label(root,text="Password",font=('arial',20,'bold'),bd=22,bg="cadet blue",fg="Cornsilk")
        #self.lblPassword.grid(row=1,column=0)
        #self.txtPassword=Entry(root,font=('arial',20,'bold'),show="*",textvariable=self.Password)
